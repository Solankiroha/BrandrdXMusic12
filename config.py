...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002118978830"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Solankiroha/BrandrdXMusic12",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Tch_shyari_Group")
